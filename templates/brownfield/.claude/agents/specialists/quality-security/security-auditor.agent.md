...
Output (write exactly one file, your own):
  .maestro/work/tasks/<task-id>/advisories/security-auditor.yaml   (per advisory.template.yaml)
...
📁 Artifact: .maestro/work/tasks/<task-id>/advisories/security-auditor.yaml
...
Do not write outside .maestro/work/tasks/<task-id>/advisories/security-auditor.yaml.
