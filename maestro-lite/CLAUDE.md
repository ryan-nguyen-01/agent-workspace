...
39 skills at `.claude/skills/*/SKILL.md`:
...
- **27 technical skills**: react, angular, vue, prisma, docker, fastapi-python, playwright-best-practices, postgresql-best-practices, aws-cloud-services, golang-pro, etc.
...
├── registry/                  ← Components, agents, all 39 skills, inputs, artifacts
