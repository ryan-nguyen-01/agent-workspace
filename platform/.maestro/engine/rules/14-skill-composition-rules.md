...
Skills are selected by task context, component stack, risk area, artifact need, and workflow state.
```
...
R-014-05: Contextual skills are selected from project/component/task metadata.
R-014-06: Generated service coders must inherit workflow skills and component-specific technical skills.
R-014-07: Skill selection must be recorded in task artifacts when it affects implementation or verification.
R-014-08: If two skills conflict, workflow rules and component knowledge win.
...
Step 1. Build candidate set from .maestro/registry/skills.yaml without opening .claude/skills/**.
        Inputs (priority order, dedup by skill name):
          ...
          c. component knowledge stack    (language, framework, db, queue, api, frontend)
...
# Inputs
task_intent: feature
impacted_components: [api-orders]
...
skills_used:
  ...
  contextual:
    - {name: typescript-advanced-types, reason: component stack match}
