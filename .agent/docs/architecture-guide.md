...
├── project-brain.yaml      ← Workspace-wide facts: stack, architecture, conventions
├── architecture.md         ← Human-readable architecture notes
├── conventions.md          ← Coding conventions and reuse guidance
├── service-catalog.yaml    ← Service inventory and real source paths
...
```text
No real secrets in .runtime artifacts or tool adapter files (R-013)
...
├── rules/           ← 19 workflow rules (constraints and governance)
