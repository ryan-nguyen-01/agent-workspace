...
Specialist advisors are the 4th agent class (see `.agent/docs/agent-taxonomy.md`): they sit beside
...
R-016-02: An advisor writes exactly one artifact: .runtime/tasks/<task-id>/advisories/<id>.yaml (its own advisory).
...
```yaml
# .runtime/tasks/<task-id>/advisories/<specialist-id>.yaml
specialist: <id>
category: <category>
task_id: <task-id>
