...
R-006-12: Built-in cross-cutting coders (`coder-infra`, `coder-database`) may be assigned only by Coder Leader after task-analysis identifies matching infra/database scope.
