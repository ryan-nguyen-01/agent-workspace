---
description: "agent-workspace /handoff-qc — Create the mandatory Dev-to-QC handoff after DEV_DONE."
argument-hint: "[request or args]"
---

You are running the agent-workspace `/handoff-qc` workflow command inside Codex.
...
(`.agent/`, `.runtime/`, `.claude/commands/handoff-qc.md`) are present, defer to them as the
