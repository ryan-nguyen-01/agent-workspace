---
description: "maestro /evals — Run and inspect LLM eval suites — the engine of the ADLC EVAL GATE. AI behavior claims require eval evidence, not dem..."
argument-hint: "[request or args]"
---

You are running the maestro `/evals` workflow command inside Codex.
...
(`.maestro/engine/`, `.maestro/registry/`, `.maestro/knowledge/`, `.maestro/work/`, `.maestro/runtime/`, `.claude/commands/evals.md`) are present, defer to them as the
authoritative contract — this prompt is a portable mirror.

User input for this command: $ARGUMENTS

---
## Command contract (mirrored from .claude/commands/evals.md)
