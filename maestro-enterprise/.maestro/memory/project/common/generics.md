...
Before creating any new helper, wrapper, mapper, validator, repository abstraction, API client, transaction helper, event helper, or test utility, service coders must check this file and the relevant component knowledge.
