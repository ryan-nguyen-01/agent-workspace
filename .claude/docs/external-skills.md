...
.claude/context/skill-registry.yaml      ← Machine config: selection policy, risk levels, auto-attach rules
```
...
- When adding a new skill: update **both** files — `skill-registry.yaml` for machine consumption and this file for human context.
