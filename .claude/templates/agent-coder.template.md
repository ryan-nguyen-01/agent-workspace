...
owner: coder-leader
created_from: .claude/templates/agent-coder.template.md
```
...
.claude/context/services/{{SERVICE_ID}}.yaml
...
- Project Brain: `.claude/context/project-brain.yaml`
- Service Brain: `.claude/context/services/<service-name>.yaml`
- Stack registry: `.claude/docs/external-skills.md`
...
- Project reusable asset index at context/common/generics.md.
- Project coding conventions at context/conventions.md.
