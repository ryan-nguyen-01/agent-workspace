...
```text
.maestro/work/tasks/<task-id>/qc-handoff.md          (standard pipeline)
.maestro/work/tasks/<task-id>/qc-test-results.yaml   (standard pipeline)
.maestro/work/tasks/<task-id>/qc-delivery-report.md  (standard pipeline)
```
