...
164 skills at `.claude/skills/*/SKILL.md`:
...
- **152 technical skills**: react, angular, vue, prisma, docker, fastapi-python, playwright-best-practices, postgresql-best-practices, aws-cloud-services, golang-pro, etc.
...
├── registry/                  ← Components, agents, all 164 skills, inputs, artifacts
